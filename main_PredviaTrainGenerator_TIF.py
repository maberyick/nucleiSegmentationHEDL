...
#names = utils.all_files_under('/mnt/pan/Data7/crb138/dataset/nuclei_ident/tma_image_qif_norm/','.tif')
names = utils.all_files_under('/mnt/pan/Data7/crb138/dataset/nuclei_ident/tma_image_qif_norm/','.tif')
for name in names:
    print(name)
    savingName = '/scratch/users/crb138/YTMA_QIF_NucGAN_norm/' + os.path.basename(name)[:-4] + '_mask'
    ...
    #image.save('/scratch/users/crb138/epiStroma_tmaYale_qif_norm_GAN/test.png')
